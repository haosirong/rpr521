...
struct ALS_PS_DATA {
	...
	unsigned int enable_stat;	//used to indicate working mode
	...
	unsigned int ps_poll_delay;	// the unit is ms I think. needed for als polling
